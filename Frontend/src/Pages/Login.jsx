...
const Login = () => {
  ...
  const handleOAuthLogin = (provider) => {
    window.location.href = `htpps://api.pinnacle-hub.nabindhakal10.com.np/auth/${provider}/login`;
  };
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <a
                ...
                className="text-sm font-medium text-transparent bg-clip-text bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 transition-all duration-300"
              >
                Forgot password?
              </a>
            </div>
